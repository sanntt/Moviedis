...
public class MovieAdapter extends ArrayAdapter<Movie> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Picasso.with(getContext()).load("http://image.tmdb.org/t/p/w185/" + movie.posterUri).into(iconView);

        TextView textView = (TextView) convertView.findViewById(R.id.list_item_id);
